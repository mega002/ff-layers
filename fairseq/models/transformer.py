...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features(
        ...
        ffn_vals: List[Tensor] = []
        fc1_vals: List[Tensor] = []
        residual_vals: List[Tensor] = []
        for idx, layer in enumerate(self.layers):
            ...
            x, layer_attn, _, layer_ffn_vals, layer_fc1_vals, layer_residual_vals = layer(
                x,
            ...
            ffn_vals.append(layer_ffn_vals)
            fc1_vals.append(layer_fc1_vals)
            residual_vals.append(layer_residual_vals)
